...
class MerchantController extends CController
{
	...
	public function actionMpesaSettings()
    {
    	
    	$this->crumbsTitle=Yii::t("default","Lipa na MPESA Settings");
    	if ( Yii::app()->functions->hasMerchantAccess("mps")){	    		
	    	$this->render('mpesa-settings');
    	} else  $this->render('noaccess');
    }
