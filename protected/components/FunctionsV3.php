...
class FunctionsV3
{
    ...
    public static function getMenu($class="menu")
    {
        ...
        $top_menu[]=array('tag'=>"browse",
                ...
                'label'=>''.Yii::t("default","Browse"),
                'url'=>array('/store/searcharea', 'location'=>'kenya'));
		...
		if ( getOptionA('merchant_disabled_registration')!="yes"){
         ...
         $top_menu[]=array('visible'=>$faq,
                'tag'=>"faq",'label'=>''.Yii::t("default","About"),
                'url'=>array('/splash'),
                'linkOptions' => array('target'=>'_blank'));  
                
        $top_menu[]=array('visible'=>$faq,
                'tag'=>"faq",'label'=>''.Yii::t("default","Support"),
                'url'=>array('/page-support'), 'linkOptions' => array('target'=>'_blank'));  
                                              
         $top_menu[]=array('visible'=>$faq,
                'tag'=>"faq",'label'=>''.Yii::t("default","Event"),
                'url'=>array('/splash/customer-rush-week-launch'),
                'linkOptions' => array('target'=>'_blank'));
...
$query=" merchant_id=".$merchant_name;
}else{	
...
/*	public static function getItemFirstPrice($prices='',$discount='')
    ...
    public static function PaymentOptionList()
    {
    	...
    	*/
        ...
        return array(
            'ipay_africa'=>t("Ipay Africa"),
			'mpesa'=>t("M-Pesa Checkout"),
   ...
   public static function getEnabledLanguageList()
   {
    ...
    public static function adminPaymentListIpay()
    {
        $payment_list=self::PaymentOptionList();
