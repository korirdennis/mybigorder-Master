...
<div class="tab-content">
  ...
  <div class="col-md-6">
     <div class="form-group" >
	    <label style="padding-right:10px;" ><?php echo AddonMobileApp::t("How to use video link")?></label>
	    <?php 
	    echo CHtml::textField('how_to_use_video',getOptionA('how_to_use_video'),array(
	        'class'=>'form-control',
	        'style'=>"width:500px;"
	    ));
	     ?>        
