...
<h4><?php echo t("Earning Points Conversion Settings")?></h4>
...
<h4><?php echo t("Redeeming Points Conversion Settings")?></h4>
...
<h4><?php echo t("Points earned for actions")?></h4>
...
<div class="form-group ">
  <label class="col-sm-3 control-label"><?php echo t("Customer can apply points over orders")?></label>
  <div class="col-sm-8">
  <?php 
