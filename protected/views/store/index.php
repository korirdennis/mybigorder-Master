<style>
#myInput {
    background-image: url('<?php echo Yii::app()->getBaseURL(true); ?>/searchicon.png'); /* Add a search icon to input */
...
function myFunction() {
    // Declare variables
    var input, filter, row, col, a, i;
    input = document.getElementById('myInput');
    filter = input.value.toUpperCase();
    row = document.getElementById("myUL");
    col = row.getElementsByTagName('div');

    // Loop through all list items, and hide those who don't match the search query
    for (i = 0; i < col.length; i++) {
        a = col[i].getElementsByTagName("a")[0];
