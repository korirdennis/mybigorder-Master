...
$this->renderPartial('/front/default-header',array(
   'h1'=>t("Browse Business"),
   'sub_text'=>t("choose from your favorite business")
));
?>
      ...
      <ul id="tabs">
		  <li class="<?php echo $tabs==1?"active":''?> noclick"  >
		    ...
		    <i class="ion-coffee"></i>
		     <span><?php echo t("Business List")?></span>
		    </a>
		  </li>
		  ...
		  <li class="full-maps nounderline">				  
		    ...
		    <i class="ion-android-globe"></i>    
		     <span><?php echo t("View Business by map")?></span>	    
		  </li>
		   </a>
      </ul>		    
      ...
      <ul id="tab">
          <li class="<?php echo $tabs==1?"active":''?>" >            
            ...
            if ( $tabs==1):
	            ...
	            } else echo '<p class="text-danger">'.t("No business found").'</p>';
            endif;
            ?>
          </li>
