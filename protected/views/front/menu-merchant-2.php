...
<div class="col-md-6 border" style="padding-left:10px;padding-right:10px;">
   <div class="box-grey">
     ...
     <p class="bold top10"><a href="<?php echo Yii::app()->createUrl("/menu-".$page_slug."?item_id=".$val_item['item_id']); ?>">
     ...
     <p class="small food-description">
     <?php echo substr($val_item['item_description'], 0, 300); ?>
     </p>
     <?php 
