...
?>
  <div class="col-md-12" style="background: #ffffff; padding-top: 15px; padding-bottom: 15px;"> 
  <!--ITEM NAME & DESCRIPTION-->
  <div class="row">
    <div class="col-md-6">              
       <img src="<?php echo FunctionsV3::getFoodDefaultImage($data['photo']);?>" alt="<?php echo $data['item_name']?>" title="<?php echo $data['item_name']?>" style="width: 100%;">
    </div> <!--col-->
    <div class="col-md-6 ">
     ...
     <?php if (is_array($gallery_photo) && count($gallery_photo)>=1):?>
      <div class="section-label">
        <a class="section-label-a">
          <span class="bold" style="background: #ffffff;">
        ...
        <div class="food-gallery-wrap row ">
          ...
          <div class="col-md-4">
            <a class="group" rel="group1" href="<?php echo websiteUrl()."/upload/$gal_val"?>">
              <img src="<?php echo websiteUrl()."/upload/$gal_val"?>" style="max-width: 100%" alt="" title="">
            </a>
          </div> <!--col-->         
          <?php endforeach;?>
...
<div class="row food-item-actions">
  <div class="col-md-6 col-xs-6 border">
       <a href="<?php echo Yii::app()->createUrl('/menu-'.$page_slug) ?>" 
