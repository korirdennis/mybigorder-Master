...
<?php echo CHtml::hiddenField('action','saveAdminMpesaSettings')?>

<!--<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","Enabled Lipa na MPESA?")?></label>
  <?php 
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","Disabled Lipa na MPESA")?>?</label>
  <?php 
  echo CHtml::checkBox('admin_enabled_paypal',
