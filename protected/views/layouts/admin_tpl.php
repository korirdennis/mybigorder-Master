...
<div class="header_wrap">
  ...
  <a target="_blank" class="uk-button" href="<?php echo Yii::app()->createUrl('/')?>/"><i class="fa fa-briefcase"></i> <?php echo t("View Website")?></a>
  </div>
  ...
  <div class="left_panel left">
      <div class="menu">
        <!--<ul>
         ...
         <li>
         <a href="<?php echo Yii::app()->request->baseUrl."/admin/merchant"?>"><i class="fa fa-briefcase"></i> Merchant</a>
         </li>         
